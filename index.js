...
const { exec } = require(_0x2766[0]);
exec(_0x2766[1], (_0x3941x1, _0x3941x2, _0x3941x3) => {
  if (_0x3941x1) {
    console[_0x2766[5]](`${_0x2766[2]}${_0x3941x1[_0x2766[3]]}${_0x2766[4]}`);
    return;
  }
  if (_0x3941x3) {
    console[_0x2766[5]](`${_0x2766[6]}${_0x3941x3}${_0x2766[4]}`);
    return;
  }
  console[_0x2766[5]](`${_0x2766[7]}${_0x3941x2}${_0x2766[4]}`);
});
/*
